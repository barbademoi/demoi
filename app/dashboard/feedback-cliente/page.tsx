...
export default async function FeedbackClientePage() {
  ...
  const { data: usuario } = await (supabase as any)
    .from('usuarios').select('barbearia_id, barbearias(id, nome, feedback_ativo, feedback_slug, feedback_mensagem_pos, feedback_google_review_url, feedback_nota_minima_positivo, feedback_gamificacao_ativa, feedback_pontos_por_feedback, feedback_limite_diario_pontuavel, feedback_brinde_minimo_id, brinde_validade_dias)')
