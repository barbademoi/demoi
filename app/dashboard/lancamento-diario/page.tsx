...
export default async function LancamentoDiarioPage() {
  ...
  // Lançamentos diários do CICLO atual (não do mês calendário)
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  // Acumulado do ciclo (lido das mesmas tabelas que o /dashboard usa, indexadas pelo mes/ano do INÍCIO do ciclo)
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        <main className="max-w-3xl mx-auto px-4 py-6 space-y-6">
          <header>
            ...
            <p className="text-text-muted text-sm font-sans mt-1">
              {ciclo.label} — lance dia por dia, a soma do {diaFechamento === 1 ? 'mês' : 'ciclo'} atualiza sozinha.
            </p>
          </header>
