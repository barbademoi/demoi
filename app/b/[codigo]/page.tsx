...
export default async function BarbeiroPage({ params }: Props) {
  ...
  // Histórico 4 ciclos pra qualquer modalidade — alimenta Comparativo,
  // HistoricoMeses e TicketMedio. Comissão do ciclo anterior derivada do array.
  ...
  // "Dias corridos no ciclo até hoje" — usado pelos componentes pra calcular ritmo
