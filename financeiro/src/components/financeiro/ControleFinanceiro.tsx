    ...
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: FONT_BODY, color: C.ink }}>
      ...
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '28px 18px 64px' }}>
        <div style={{ marginBottom: 18 }}>
          <a href="/api/sair" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: FONT_BODY, fontSize: 13, fontWeight: 600, color: C.inkSoft, background: C.surface, border: `1px solid ${C.line}`, borderRadius: 9, padding: '8px 14px', textDecoration: 'none' }}>
