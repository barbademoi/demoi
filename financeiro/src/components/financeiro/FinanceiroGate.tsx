  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: FONT, color: C.ink, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ maxWidth: 460, width: '100%', background: C.surface, border: `1px solid ${C.line}`, borderRadius: 16, padding: 28, textAlign: 'center' }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: C.primary, textTransform: 'uppercase' }}>Controle Financeiro</div>
        ...
        {status === 'loading' ? (
          ...
          <>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 700, margin: '8px 0 6px' }}>Controle Financeiro da barbearia</h2>
            <p style={{ color: C.inkSoft, fontSize: 14, lineHeight: 1.5, margin: '0 0 14px' }}>
              Tudo o que entra e sai num lugar só:
            </p>
            <ul style={{ textAlign: 'left', listStyle: 'none', padding: 14, margin: '0 0 18px', background: 'rgba(255,255,255,0.04)', borderRadius: 10, fontSize: 13.5, lineHeight: 1.5 }}>
              <li style={{ marginBottom: 8, color: C.ink }}>
                ...
                <strong>Caixa e contas</strong> — <span style={{ color: C.inkSoft }}>contas a pagar e a receber, por mês e por categoria</span>
              </li>
              <li style={{ marginBottom: 8, color: C.ink }}>
                <span style={{ color: C.primary, marginRight: 6 }}>✓</span>
                <strong>Folha da equipe</strong> — <span style={{ color: C.inkSoft }}>comissões, descontos e bônus por colaborador</span>
              </li>
              <li style={{ color: C.ink }}>
                <span style={{ color: C.primary, marginRight: 6 }}>✓</span>
                <strong>Quanto sobra no mês</strong> — <span style={{ color: C.inkSoft }}>fluxo de caixa e resultado, separados por empresa e pessoal</span>
              </li>
            </ul>
