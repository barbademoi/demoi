      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-2 px-3 sm:px-6">
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <div className="hidden sm:block">
            <CTAButton size="sm" label="Testar por 30 dias →" id="cta-navbar-planos-desktop" gtmClass="gtm-cta-navbar" />
          </div>
          ...
          <div className="flex min-w-0 items-center gap-1.5 sm:hidden">
            ...
            <CTAButton size="sm" label="Testar · R$ 34,90" id="cta-navbar-planos-mobile" gtmClass="gtm-cta-navbar" />
          </div>
        </div>
      </div>
    </header>
