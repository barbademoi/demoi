    ...
    <section id="preco" className="scroll-mt-20 bg-[#0A1929] px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <article className="relative flex flex-col items-center gap-5 rounded-3xl border-2 border-[#D4A85A] bg-gradient-to-b from-[#0F1F2D] to-[#1A1410] p-7 sm:p-8">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[#D4A85A] px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-[#0F1117]">Oferta principal</div>
            <div className="text-center">
              <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-[#D4A85A]">BarberMeta</p>
            ...
            <a href={URL_BM} id="cta-preco-bm-47" target="_blank" rel="noopener noreferrer" {...trackingHandlers} className="gtm-cta gtm-cta-preco cta-bm w-full rounded-xl bg-[#D4A85A] px-5 py-3.5 text-center text-base font-bold text-[#0F1117] transition-colors hover:bg-[#E6CB8A]">Quero o BarberMeta — R$ 47</a>
          ...
          <article className="flex flex-col items-center gap-5 rounded-3xl border border-white/15 bg-[#0F1F2D] p-7 sm:p-8">
            <div className="text-center">
              <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-[#A0AEC0]">BarberMeta + Financeiro</p>
              <p className="mb-1 text-xs text-[#A0AEC0]">pagamento único</p>
              <p className="text-5xl font-bold leading-none text-white">R$ 67</p>
              <p className="mt-2 text-xs font-semibold text-[#D4A85A]">Economize R$ 9,90 vs comprar separado</p>
            </div>
            <ul className="w-full space-y-2">
            ...
            <a href={URL_COMBO} id="cta-preco-combo-67" target="_blank" rel="noopener noreferrer" {...trackingHandlers} className="gtm-cta gtm-cta-preco cta-combo w-full rounded-xl border border-white/25 bg-transparent px-5 py-3.5 text-center text-base font-bold text-white transition-colors hover:bg-white/5">Quero o Combo — R$ 67</a>
            <p className="-mt-1 text-xs text-[#A0AEC0]">Garantia incondicional de 7 dias</p>
          </article>
        </div>
      </div>
