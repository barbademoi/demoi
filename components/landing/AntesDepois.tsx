...
const demonstracao = [
  ...
  { badge: 'Lançamento', badgeClass: 'border-emerald-800/40 bg-emerald-950/40 text-emerald-400', img: '/prints/img_6057.png', width: 900, height: 1367, alt: 'Tela do BarberMeta para lançar serviços do dia', legenda: 'O barbeiro recebe o link — sem app, sem senha — e lança o próprio dia em 2 minutos.' },
  { badge: 'Acompanhamento', badgeClass: 'border-[#D4A85A]/40 bg-[#D4A85A]/15 text-[#D4A85A]', img: '/prints/img_6058.png', width: 900, height: 1488, alt: 'Dashboard do barbeiro mostrando ritmo, pontuação e metas', legenda: 'O time acompanha sozinho: ritmo, quanto falta pra meta e a posição no ranking.' },
]
    ...
    <section className="bg-[#0A1929] px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-[#A0AEC0] sm:text-lg">Você configura as metas uma vez. O barbeiro recebe o link e lança o dia. O time acompanha sozinho.</p>
        </div>
