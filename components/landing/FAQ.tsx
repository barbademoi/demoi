const perguntas = [
  ...
  {
    q: 'A Brindoleta está incluída?',
    a: 'Sim. Para novos assinantes, a Brindoleta já vem liberada com todos os recursos, incluindo QR Code por profissional, ofertas configuráveis e acompanhamento das vendas geradas.',
  },
  {
  ...
  },
  {
    ...
    a: 'A cobrança e a renovação são processadas pela Hotmart conforme o plano escolhido. A assinatura pode ser gerenciada pela área de compras da própria Hotmart.',
  },
]
